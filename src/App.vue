<template>
  <div>
    <div style="margin:10% 40%; width:250px">
      ...
      <!-- <ejs-multiselect :dataSource='dataItem' 
      :fields='dataFields' placeholder='Select a platform'
      :itemTemplate='multiselectItemTemplate'
      :headerTemplate='multiselectHeaderTemplate'
      :footerTemplate='multiselectFooterTemplate'>
      </ejs-multiselect> -->

      <!-- ValueTemplate, GroupTemplate Code Snippet -->
      <ejs-multiselect  
      :dataSource='dataItem' :fields='dataFields' placeholder='Select a name'
      :valueTemplate="multiselectValueTemplate"
      :groupTemplate="multiselectGroupTemplate">
      </ejs-multiselect>
      </div>
    </div>
</template>
...
export default Vue.extend({
  data: function() {
    return {
      ...
      // ValueTemplate, GroupTemplate Code Snippet
      multiselectValueTemplate:"<span>${Name} - ${Designation}</span>",
      multiselectGroupTemplate:"<b><i>${Country}</i></b>",
      dataItem: [
        {Id:1,Name:"Anne Dodsworth",Designation:"Developer",Country:"USA"},
        {Id:2,Name:"Janet Leverling",Designation:"HR",Country:"USA"},
        {Id:3,Name:"Margaret Peacock",Designation:"Developer",Country:"USA"},
        {Id:4,Name:"Robert King",Designation:"Developer ",Country:"England"},
        {Id:5,Name:"Steven Buchanan",Designation:"CEO",Country:"England"}],
      
      dataFields: { text: 'Name', value: 'Id', groupBy: 'Country' }

      // ItemTemplate, HeaderTemplate, FooterTemplate Code Snippet 
      // multiselectItemTemplate:"<div class='list-wrapper'><span class= '${Image} e-avatar'></span><span class='text'>${Name}</span></div>",
      // multiselectHeaderTemplate:"<span class='header'><span class='img'>Photo</span><span class='name'>Platform</span></span>",
      // multiselectFooterTemplate:"<span class='footer'> Total list item: 5</span>",
      // dataItem: [
